...
async def get_itinerary(lat: float, lon: float, city_id: str, tags: Optional[List[str]] = None):
    ...
    try:
        ...
        # Prepare a prompt that merges instructions with the JSON data
        # prompt = (
        ...
        #     "[Day X:\n"
        #     "  1. Visit <Place Name>  (Description: <A 2–3 sentence summary of this place>)\n(visit duration: H hr M min). Travel to <Next Place>: D km; travel time: H hr M min.\n"
        #     "     "
        #     "  2. Visit <Next Place>  (Description: <…>)\n (visit duration: …). Travel to <Next Next Place>: …\n"
        #     "     "
        #     "]\n\n"
        ...
        prompt = (
            ...
            "      Travel to <Next Place>: (D km); (travel time: H hr M min).\n\n"
            "   2. Visit <Next Place> (Description: <…>)\n"
            "      (visit duration: …).\n"
            "      Next Location: <Next Next Place>\n"
            "      Travel to <Next Next Place>: (… km); (travel time: …).\n"
            "]\n\n"
